...
gray=(119,118,110)
black=(0,0,0)
dark_green=(51,102,255)
red=(255,153,204)
bright_green=(51,153,102)
blue=(0,0,200)
yellow=(255,255,0)
bright_red=(255,102,0)
green=(204,255,204)
bright_blue=(0,0,255)
bright_yellow=(255,200,0)
bright_purple=(102,0,102)

#load images and sound
mixer.music.load('sound/background.mp3')
mixer.music.set_volume(0.2)
countdown_1 = pygame.mixer.Sound("sound/s1.ogg")
countdown_2 = pygame.mixer.Sound("sound/s2.ogg")
countdown_3 = pygame.mixer.Sound("sound/s3.ogg")
crash_sound = pygame.mixer.Sound("sound/crash1.wav")
button_click = pygame.mixer.Sound("sound/click.mp3")
pygame.mixer.Sound.set_volume(countdown_1, 0.2)
pygame.mixer.Sound.set_volume(countdown_2, 0.2)
pygame.mixer.Sound.set_volume(countdown_3, 0.2)
pygame.mixer.Sound.set_volume(crash_sound, 0.5)
pygame.mixer.Sound.set_volume(button_click, 0.7)
gamedisplays=pygame.display.set_mode((display_width,display_height))
pygame.display.set_caption("go go car !")
clock=pygame.time.Clock()
carimg=pygame.image.load('image/car1.png')
backgroundpic=pygame.image.load("image/download12.png")
yellow_strip=pygame.image.load("image/yellow strip.png")
strip=pygame.image.load("image/strip.jpg")
intro_background=pygame.image.load("image/background.jpg")
instruction_background=pygame.image.load("image/background2.jpg")
car_width=56
pause=False
...
def intro_loop():
    ...
    while intro:
        ...
        TextSurf,TextRect=text_objects("go go car !",largetext)
        TextRect.center=(400,100)
        gamedisplays.blit(TextSurf,TextRect)
        button("START",150,250,100,50,green,bright_green,"play")
        button("QUIT",550,250,100,50,red,bright_red,"quit")
        button("INSTRUCTION",300,230,200,50,yellow,bright_yellow,"intro")
...
#function for displaying game instruction
def introduction():
    introduction=True
    while introduction:
        for event in pygame.event.get():
        ...
        button("BACK",600,450,100,50,yellow,bright_yellow,"menu")
        pygame.display.update()
        clock.tick(30)

#function for displaying menu 2
def paused():
    global pause
    ...
    while pause:
            ...
            button("RESTART",350,450,150,50,yellow,bright_yellow,"play")
...
def countdown_background():
    ...
    score=font.render("SCORE : 0 ", True,yellow)
    gamedisplays.blit(text,(0,50))
    gamedisplays.blit(score,(0,30))
    button("PAUSE",650,0,150,50,green,bright_green,"pause")

#function for countdown 3..2..1.. before game start
def countdown():
    countdown=True
    ...
    while countdown:
            ...
            pygame.mixer.Sound.play(countdown_3)
            pygame.mixer.music.stop()
            largetext=pygame.font.Font('freesansbold.ttf',115)
            ...
            gamedisplays.fill(black)
            countdown_background()
            pygame.mixer.Sound.play(countdown_2)
            pygame.mixer.music.stop()
            largetext=pygame.font.Font('freesansbold.ttf',115)
            ...
            gamedisplays.fill(black)
            countdown_background()
            pygame.mixer.Sound.play(countdown_1)
            pygame.mixer.music.stop()
            largetext=pygame.font.Font('freesansbold.ttf',115)
...
def score_system(passed,score):
    font=pygame.font.SysFont(None,25)
    text=font.render("Passed "+str(passed),True,purple)
...
def text_objects(text,font):
    textsurface=font.render(text,True,dark_green)
...
#function for show message if car bumped with another car
def crash():
